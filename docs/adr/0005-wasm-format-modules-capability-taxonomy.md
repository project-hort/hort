...
- **SignedIndex** (Debian, RPM), **MultiFileArtifact** (Maven, Go), **ProtocolNativeIntegrity** (OCI), **StatefulUpload** (OCI blob upload, Git LFS), **VersionDiscovery** (npm, PyPI, Cargo, Maven).
