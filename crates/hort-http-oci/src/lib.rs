...
pub(crate) const UPSTREAM_PROXY_FORMAT: RepositoryFormat = RepositoryFormat::Oci;
...
mod tests {
    ...
    fn upstream_proxy_format_is_this_crates_served_format() {
        assert_eq!(
            UPSTREAM_PROXY_FORMAT,
            hort_domain::entities::repository::RepositoryFormat::Oci
        );
        assert_eq!(UPSTREAM_PROXY_FORMAT.to_string(), "oci");
        assert!(
