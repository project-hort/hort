...
impl IndexSource for ProxyNpmSource {
    ...
    async fn fetch(
        ...
        .await
        {
            ...
            Err(PackumentFetchError::MetadataMalformed { cause: _ }) => {
                ...
                // the construction site in `packument.rs`). Fail-closed:
                ...
                hort_app::metrics::emit_upstream_parse_error("npm", repo_label);
                return Err(AppError::Domain(
